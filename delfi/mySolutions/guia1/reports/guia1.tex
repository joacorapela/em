...
\begin{align*}
    E(0,0,d)=\frac{d\sigma}{2\epsilon_0}\left(\frac{1}{\sqrt{R_i^2+d^2}}-\frac{1}{\sqrt{R_e^2+d^2}}\right)\hat{k}
\end{align*}

\subsection*{Parte b}

\begin{align*}
    \lim_{R_i\rightarrow 0}E(0,0,d)=\frac{d\sigma}{2\epsilon_0}\left(\frac{1}{|d|}-\frac{1}{\sqrt{R_e^2+d^2}}\right)\hat{k}
\end{align*}

\subsection*{Parte c}

\begin{align*}
    E(0,0,d=0.1m|R=0.05m,\sigma=0.5\mu C/m^2)=0.003\;\hat{k}\;N/\mu C
\end{align*}

\subsection*{Parte d}

\begin{align*}
    \lim_{R_i\rightarrow 0,R_e\rightarrow\infty}E(0,0,d)=\frac{\sigma}{2\epsilon_0}\sign(d)\;\hat{k}
\end{align*}

\subsection*{Parte e}

Podemos expresar el resultado de la parte b como:

\begin{align*}
    \lim_{R_i\rightarrow
    0}E(0,0,d)=\frac{\sigma}{2\epsilon_0}\left(\sign(d)-\frac{1}{\sqrt{(R_e/d)^2+1}}\right)\hat{k}
\end{align*}

\noindent Esta ecuación muestra que el campo eléctrico depende sólo del cociente
entre $R_e$ y $d$, por lo que es equivalente llevar $R_e$ a infinito que llevar
$d$ a zero.
