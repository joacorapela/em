...
\begin{align*}
    E(x_0,y_0,z_0)&=\frac{\lambda}{4\pi\epsilon_0}\left(\frac{1}{\sqrt{(x_0-L/2)^2+y_0^2}}-\frac{1}{\sqrt{(x_0+L/2)^2+y_0^2}}\right.,\\
...
La figura~\ref{fig:7bc} grafica $||E(0,y_0,0)||_2$ en function de $y_0$,
...
\begin{figure}
    ...
    \caption{$||E(0,y_0,0)||_2$ en function de $y_0$, usando $\lambda=15\mu
    C/m$ y $L=0.5m$ (barras azules) o $L=\infty$ (barras rojas). Haga click en
    la imagen para ver su version interactiva. El código usado para construir
...
La figura~\ref{fig:7d} grafica las diferencias percentuales entre el uso de
$L=0.5m$ y $L=\infty$ (i.e.,
$\frac{E_{L=0.5m}(0,y_0,0)-E_{L=\infty}(0,y_0,0)}{E_{L=\infty}(0,y_0,0)}$).

No entiendo porque para $y_0<1$ el campo eléctrico es mayor para $L=0.5m$ que
para $L=\infty$, y para $y_0>1$ sucede a la inversa.
...
\begin{figure}
    ...
    \caption{Diferencias percentuales entre el uso de $L=0.5m$ y $L=\infty$
    (i.e.,
    $\frac{E_{L=0.5m}(0,y_0,0)-E_{L=\infty}(0,y_0,0)}{E_{L=\infty}(0,y_0,0)}$).
    Haga click en la imagen para ver su version interactiva.  El código usado
